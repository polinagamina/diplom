...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/deleteMain").authenticated()
		.antMatchers("/deleteMine").authenticated().antMatchers("/unhideMine").authenticated().antMatchers("/download").permitAll().antMatchers("/makeNoise").permitAll()
